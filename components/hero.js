...
export default function HeroSection() {
  ...
  return (
    ...
    <Carousel onSlideChange={(index) => setState(index)}>
      ...
      <div className="h-full items-center justify-center bg-gradient-to-br from-green-400 to-green-700 text-white">
        <div className="grid sm:grid-rows-2 md:grid-cols-2">
            <div className="md:order-last"><Image src="https://res.cloudinary.com/dafshcwj1/image/upload/v1730387742/audit-6904474_1920-removebg-preview_lpsgiq.png" className="object-scale-down" alt="2" width={400} height={400} /></div>
      ...
      <div className="h-full items-center justify-center bg-gradient-to-br from-green-400 to-green-700 text-white">
        <div className="grid sm:grid-rows-2 md:grid-cols-2">
            <div className="md:order-last object-scale-down"><Image src="https://res.cloudinary.com/dafshcwj1/image/upload/v1730387804/tax-7630744_1280-removebg-preview_ssuh3i.png" className="object-scale-down"  alt="3" width={400} height={400} /></div>
